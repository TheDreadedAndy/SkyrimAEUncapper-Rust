    ...
    pub static HOOK_SIGNATURES: [Descriptor; NUM_HOOK_SIGNATURES] = [
        ...
        Descriptor {
            ...
            object: DescriptorObject::Patch {
                ...
                sig: signature![
                    0x48, 0x8b, 0x0d, ?, ?, ?, ?,
                    0x48, 0x81, 0xc1, (0xb0 | 0xb8), 0x00, 0x00, 0x00,
                    0x48, 0x8b, 0x01,
        ...
        Descriptor {
            ...
            object: DescriptorObject::Patch {
                ...
                sig: signature![
                    0x48, 0x8b, 0x15, ?, ?, ?, ?,
                    0x0f, 0xb6, 0x8a, (0x01 | 0x09 | 0x11), 0x0b, 0x00, 0x00,
                    0x8b, 0xc1,
                    0x03, 0xc7,
                    0x78, 0x09,
                    0x40, 0x02, 0xcf,
                    0x88, 0x8a, (0x01 | 0x09 | 0x11), 0x0b, 0x00, 0x00; 29
                ]
            }
        },
        Descriptor {
            ...
            object: DescriptorObject::Patch {
                ...
                sig: signature![
                    0x48, 0x8b, 0x15, ?, ?, ?, ?,
                    0x0f, 0xb6, 0x8a, 0x01, 0x0b, 0x00, 0x00,
                    0x8b, 0xc1,
                    0x03, 0xc3,
                    0x78, 0x08,
                    0x02, 0xcb,
                    0x88, 0x8a, 0x01, 0x0b, 0x00, 0x00; 28
                ]
            }
        },
        ...
        Descriptor {
            ...
            object: DescriptorObject::Patch {
                ...
                sig: signature![
                    0x8b, 0xd0,
                    0x48, 0x8d, 0x8f, (0xb0 | 0xb8), 0x00, 0x00, 0x00,
                    0xff, 0x53, 0x18; 12
                ]
            }
        },
...
extern "system" fn calculate_charge_points_per_use_hook(
    ...
    if SETTINGS.enchant.use_linear_charge.get() {
        ...
        base * (1.0 - powf(enchanting_level * cost_base, cost_scale))
    }
}
